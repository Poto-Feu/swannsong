...
namespace token
{
    ...
    static auto add_tokens_to_arr(std::string const& p_str)
    {
        ...
        auto set_tokens_type = [](TokenVec& p_vec)
        {
            auto is_if = [](std::string const& p_tkn)
            {
            ...
            auto is_not = [](std::string const& p_tkn)
            {
                if(p_tkn == "NOT" || p_tkn == "!") return true;
                else return false;
            };

            auto is_has = [](std::string const& p_tkn)
            {
                if(p_tkn == "HAS") return true;
                else return false;
            };

            auto is_number = [](std::string& p_tkn)
            {
            ...
            auto is_string = [](std::string p_tkn)
            {
            ...
            auto is_string_id = [](std::string p_tkn)
            {
            ...
            auto is_new_var = [](TokenVec const& p_vec, int p_ind)
            {
                if(p_vec[0].str == "SET" && p_ind == 1) return true;
                else return false;
            };

            auto is_exists = [](std::string const& p_tkn)
            {
        ...
        auto create_token_vector = [&](std::string p_str)
        {
